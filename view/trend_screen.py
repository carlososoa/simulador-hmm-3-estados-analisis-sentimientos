...
from graphs import create_step_chart, fig_to_surface
...
class TrendScreen(Screen):
    ...
    def draw(self, screen):
        ...
        draw_text(screen, "Análisis de Tendencia", self.font_title,
                  TEXT_COLOR, 640, 35, center=True)
        draw_text(screen, "Evolución de los estados a lo largo de las iteraciones",
